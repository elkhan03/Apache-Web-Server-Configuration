...
apache-project/ │ ├── index.html ├── README.md └── screenshots/
/web/project
...
<VirtualHost *:80> ServerName project.local Redirect permanent / https://project.local/
<VirtualHost *:443> ServerName project.local DocumentRoot /web/project
SSLEngine on
...
Access Log: /var/log/httpd/project-access.log
Error Log: /var/log/httpd/project-error.log
Testing

Open in browser:
http://project.local https://project.local
Screenshots
